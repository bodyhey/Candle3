...
class Cube {
    ...
    private m_eye = glMatrix.vec3.create();
    private m_lookAt = glMatrix.vec3.create();
    private m_viewMatrix = glMatrix.mat4.create();
    private m_projectionMatrix = glMatrix.mat4.create();
    private lightRot: number = 0.2;
    private m_zoomDistance: number = Utils.DEFAULT_ZOOM;
    private m_fov: number = 36.0;
    private m_near: number = 1.5;
    private m_far: number = 1000;
    private m_perspective: boolean = false;
    private m_xRot: number = 0.0;
    private m_yRot: number = 0.0;    
